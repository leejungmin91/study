package com.min.store.common.http;
...
public enum ApiCode {
	...
	LOGIN_DENIED(HttpStatus.BAD_REQUEST, "1001", "아이디 또는 비밀번호를 확인해주세요."),
	ACCESS_DENIED(HttpStatus.UNAUTHORIZED, "1002", "권한이 없습니다."),
	TOKEN_NOT_VALID(HttpStatus.UNAUTHORIZED, "1003", "토큰이 유효하지 않습니다."),
	TOKEN_EXPIRED(HttpStatus.INTERNAL_SERVER_ERROR, "1004", "토큰이 만료되었습니다."),
